...
import siheungLogo from '../data/logo.png';
		...
		<Container maxWidth="sm" className={classes.searchContainer}>
				<a href='.' className={classes.title}>
					<div style={{width:"100%", textAlign:'center'}}>
						<img src={siheungLogo} alt="logo" style={{verticalAlign:'bottom', maxWidth:"120px", width:"100%"}}></img>
						<h2 style={{margin:"7px", fontSize:"min(6vw, 24px)"}}>
							 노후소방시설 안전컨설팅 플랫폼
						</h2>
					</div>
				</a>
